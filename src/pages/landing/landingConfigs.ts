...
export const LANDING_CONFIGS: Record<string, LandingConfig> = {
  "flooring-estimating-software": {
    ...
    h1Lines: ["Flooring estimating", "software that pays", "for itself."],
    intro:
  ...
  "flooring-takeoff-software": {
    ...
    h1Lines: ["Flooring takeoff,", "done in the time", "it takes for tea."],
    intro:
  ...
  "carpet-estimating-software": {
    ...
    h1Lines: ["Carpet estimating", "without the", "guesswork."],
    intro:
  ...
  "vinyl-flooring-calculator": {
    ...
    h1Lines: ["Vinyl flooring", "calculator with", "actual cut planning."],
    intro:
